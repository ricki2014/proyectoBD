...
{
    public partial class fmReporteAsignaturas : Form
    {
        cLogicaBD OLogicaBD;
        /* CONSTRUCTOR */
        /* ********************************************************** */
        public fmReporteAsignaturas(SqlConnection OConexionBD_)
        {
            InitializeComponent();
        ...
        public void Inicializar()
        {
            ...
            DataSet ODS = OLogicaBD.ProcedimientoAlmacenado("spu_AsignaturasSelect", out Error);
            if (Error == null)
            {
